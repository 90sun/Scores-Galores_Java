...
//				links.add("https://www.goaloo.site/football/husumer-sv-vs-sv-todesfelde/h2h-2316514");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2316069");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2215092");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2284401");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2284400");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2284402");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2319766");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2320034");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2320317");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2278321");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2239128");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2239378");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2292022");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2239379");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2251812");
//				links.add("https://www.goaloo.mobi/football/match/h2h-2251813");
...
//						|| league2.contains("Spanish")
//						|| league2.contains("Spain")
...
//				
				...
				if ( (Float.compare(FTtotalMinExpectedRegProb, (float) 3.0) >= 0) )
					oddsBetThis++;
				if ( (Float.compare(FTtotalMinExpectedRegProb, (float) 3.5) >= 0) )
					oddsBetThis++;
				if ( (Float.compare(FTtotalMinExpectedRegProb, (float) 4.0) >= 0) )
					oddsBetThis++;
				...
				if(((Float.compare(minMaxOdds, (float) 1.2) <  0) && !tier.equals("E")) || ( tier.equals("A") && (Float.compare(minMaxOdds, (float) 1.35) <  0) ))
					oddsBetThis++;
...
//			
				...
				if ((Float.compare(formOddsDiff, (float) 1) <  0) && (Float.compare(formOddsDiff, (float) -1.4) >  0))
					continue;
////
...
//		
//				
				if( (Float.compare(formOddsDiff, (float) 0) >  0) &&  (Float.compare(HTMinRegOne, (float) 0.8) >=  0) && (Float.compare(minMaxOdds, (float) 1.4) <  0)  && (Float.compare(FTMinRegForm, (float) 1.5) <  0)  )
					betType = "1HG";
